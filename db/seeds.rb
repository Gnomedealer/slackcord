...
tommy = User.create!({username: 'tommy', email: 'tommy@email.com', password: 'password'})
melissa = User.create!({username: 'melissa', email: 'melissa@email.com', password: 'password'})
demo_user = User.create!({username: 'demo', email: 'demo@email.com', password: 'password'})
elijah = User.create!({username: 'elijah', email: 'elijah@email.com', password: 'password'})
hezekiah = User.create!({username: 'hezekiah', email: 'hezekiah@email.com', password: 'password'})
jeremiah = User.create!({username: 'jeremiah', email: 'jeremiah@email.com', password: 'password'})
azariah = User.create!({username: 'azariah', email: 'azariah@email.com', password: 'password'})
...
# demo_user_friend_1 = Friend.create!({user_id: demo_user.id, friend_id: tommy.id})
# demo_user_friend_2 = Friend.create!({user_id: demo_user.id, friend_id: melissa.id})
# demo_user_friend_3 = Friend.create!({user_id: demo_user.id, friend_id: elijah.id})
# demo_user_friend_4 = Friend.create!({user_id: demo_user.id, friend_id: hezekiah.id})
# demo_user_friend_5 = Friend.create!({user_id: demo_user.id, friend_id: jeremiah.id})
# demo_user_friend_6 = Friend.create!({user_id: demo_user.id, friend_id: azariah.id})

lotr = Server.create!(name: 'LoTR', owner_id: tommy.id)
